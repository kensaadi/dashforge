# Changelog — @dashforge/tokens

All notable changes to `@dashforge/tokens` are documented in this file.
...
- Packaging: the published tarball now includes `CHANGELOG.md` so consumers
  can read release history directly from `node_modules/@dashforge/tokens/`.
...
See git history at <https://github.com/kensaadi/dashforge/commits/main/libs/dashforge/tokens>.
