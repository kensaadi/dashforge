...
/**
 * OTPFieldCapabilities documents the progressive adoption model
 * Explains Controlled, React Hook Form, and Reactive capabilities
 */
export function OTPFieldCapabilities() {
  ...
  return (
    <Stack spacing={4}>
      <Box>
        ...
        >
          Use OTPField as a controlled component, integrate with React Hook
