...
/**
 * CheckboxCapabilities documents the progressive adoption model
 * Explains Controlled, React Hook Form, and Reactive capabilities
 */
export function CheckboxCapabilities() {
  ...
  return (
    <Stack spacing={4}>
      <Box>
        ...
        >
          Checkbox is designed for progressive adoption. Use it as a simple
