...
/**
 * SwitchCapabilities documents the progressive adoption model
 * Explains Controlled, React Hook Form, and Reactive capabilities
 */
export function SwitchCapabilities() {
  ...
  return (
    <Stack spacing={4}>
      <Box>
        ...
        >
          Switch is designed for progressive adoption. Use it as a simple
