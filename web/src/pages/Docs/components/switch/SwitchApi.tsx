...
const props: ApiPropDefinition[] = [
  ...
  },
  {
    ...
    description:
      'Label text displayed next to the switch. When provided, wraps the switch in FormControlLabel.',
  },
  {
    name: 'checked',
    type: 'boolean',
  ...
  },
  {
    ...
    type: 'string',
    description:
      'Helper text displayed below switch. Explicit helperText prop overrides form-provided validation error message. When inside DashForm, validation errors display as helperText (gated by touched/submitted state).',
  },
  {
    name: 'disabled',
    type: 'boolean',
  ...
  },
  {
    ...
    description:
      'Validation rules for DashForm integration. Format follows React Hook Form rules contract. Only used when inside DashForm—ignored in standalone mode. Useful for enforcing toggle requirements in specific contexts.',
  },
  {
    name: 'visibleWhen',
...
/**
 * SwitchApi displays the props table for Switch component
 */
  ...
  return (
    <Stack spacing={2}>
      ...
      >
        ...
        Switch receives checked, error, helperText, onChange, and onBlur
