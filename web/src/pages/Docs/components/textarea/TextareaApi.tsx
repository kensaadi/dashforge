...
const props: ApiPropDefinition[] = [
  ...
  },
  {
    ...
    defaultValue: '3',
    description:
      'Minimum number of rows to display. Textarea automatically expands as content grows.',
  },
  {
    name: 'error',
    type: 'boolean',
  ...
  },
  {
    ...
    type: 'string',
    description:
      'Helper text displayed below textarea. Explicit helperText prop overrides form-provided validation error message. When inside DashForm, validation errors display as helperText (gated by touched/submitted state).',
  },
  {
    name: 'disabled',
    type: 'boolean',
  ...
  },
  {
    ...
    description:
      'Validation rules for DashForm integration. Format follows React Hook Form rules contract (required, minLength, maxLength, pattern, validate, etc.). Only used when inside DashForm—ignored in standalone mode.',
  },
  {
    name: 'visibleWhen',
...
/**
 * TextareaApi displays the props table for Textarea component
 */
export function TextareaApi() {
  ...
  return (
    <Stack spacing={2}>
      ...
      >
        ...
        Textarea receives value, error, helperText, onChange, and onBlur
