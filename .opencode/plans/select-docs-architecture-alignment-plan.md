    ...
    <Box sx={{ p: { xs: 3, md: 4 }, /* styling */ }}>
      ...
      >
        <Stack spacing={2.5}>
          ...
          <Typography variant="caption" sx={{ /* styling */ }}>
            Notice: When you change country, the city field shows loading state,
            then displays cities for the selected country. If you had a city selected
            and switch countries, the display clears but the form value remains
            (no automatic reset).
          </Typography>
        </Stack>
      </DashForm>
